...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlannedSkill'
        db.create_table(u'plans_plannedskill', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'plans', ['PlannedSkill'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PlannedSkill'
        db.delete_table(u'plans_plannedskill')
    ...
    models = {
        ...
        u'plans.plannedskill': {
            'Meta': {'object_name': 'PlannedSkill'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
