...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'characters_apikey', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='api_keys', to=orm['users.User']),
                      keep_default=False)


        # Changing field 'Character.apikey'
        db.alter_column(u'characters_character', 'apikey_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['characters.ApiKey']))

    def backwards(self, orm):
        # Deleting field 'ApiKey.user'
        db.delete_column(u'characters_apikey', 'user_id')


        # User chose to not deal with backwards NULL issues for 'Character.apikey'
        raise RuntimeError("Cannot reverse this migration. 'Character.apikey' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Character.apikey'
        db.alter_column(u'characters_character', 'apikey_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['characters.ApiKey']))
