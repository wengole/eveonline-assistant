...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.enabled'
        db.add_column(u'characters_character', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.enabled'
        db.delete_column(u'characters_character', 'enabled')
    ...
    models = {
        ...
        u'characters.skillqueue': {
            'Meta': {'object_name': 'SkillQueue'},
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['characters.Character']"}),
            'end_sp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'start_sp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'characters.skilltrained': {
            'Meta': {'ordering': "['skill__name']", 'object_name': 'SkillTrained'},
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['characters.Character']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'skill': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['skills.Skill']"}),
